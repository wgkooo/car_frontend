   ...
   mounted() {
    // 初始化折线图
     ...
     this.allDiscountPieCharts.on('click',(params)=>{
        ...
        this.carseriesDiscountPieOption['series'][0]['data'] = []
        this.carseriesDiscountPieOption['series'][1]['data'] = []
        this.carseriesDiscountPieOption['series'][2]['data'] = []
        this.carseriesDiscountPieOption['series'][3]['data'] = []
        this.carseriesDiscountPieOption['series'][4]['data'] = []
        this.carseriesDiscountPieOption['series'][5]['data'] = []
        this.carseriesDiscountPieOption['series'][6]['data'] = []
        this.carseriesDiscountPieOption['series'][7]['data'] = []
        this.carseriesDiscountPieOption['series'][8]['data'] = []
        this.carseriesDiscountPieOption['series'][9]['data'] = []
        this.carseriesDiscountPieOption['series'][10]['data'] = []
        this.carseriesDiscountPieOption['series'][11]['data'] = []
        this.carseriesDiscountPieOption['series'][12]['data'] = []
        ...
        getBrandData(brand,type){
            ...
            this.axios({
                ...
                params:{brand: brand}
                    ...
                    if(type == 1){
                        //设置月份
                        this.allDiscountPieOption.xAxis.data = [resp.data[11].englishbuymonth,resp.data[10].englishbuymonth,resp.data[9].englishbuymonth,resp.data[8].englishbuymonth,resp.data[7].englishbuymonth,resp.data[6].englishbuymonth,resp.data[5].englishbuymonth,resp.data[4].englishbuymonth,resp.data[3].englishbuymonth,resp.data[2].englishbuymonth,resp.data[1].englishbuymonth,resp.data[0].englishbuymonth]
                        //设置车标名字
                        this.allDiscountPieOption['series'][0]['name'] = resp.data[0]['brand']
                        //设置对应月份的数据
                        this.allDiscountPieOption['series'][0]['data'] = [resp.data[11].discount,resp.data[10].discount,resp.data[9].discount,resp.data[8].discount,resp.data[7].discount,resp.data[6].discount,resp.data[5].discount,resp.data[4].discount,resp.data[3].discount,resp.data[2].discount,resp.data[1].discount,resp.data[0].discount,]
        this.allDiscountPieCharts.setOption(this.allDiscountPieOption)
                    }else if(type == 2){
                        //设置车标名字
                        this.allDiscountPieOption['series'][1]['name'] = resp.data[0]['brand']
                        //设置对应月份的数据
                        this.allDiscountPieOption['series'][1]['data'] = [resp.data[11].discount,resp.data[10].discount,resp.data[9].discount,resp.data[8].discount,resp.data[7].discount,resp.data[6].discount,resp.data[5].discount,resp.data[4].discount,resp.data[3].discount,resp.data[2].discount,resp.data[1].discount,resp.data[0].discount,]
        this.allDiscountPieCharts.setOption(this.allDiscountPieOption)
                    }else if(type == 3){
                        //设置车标名字
                        this.allDiscountPieOption['series'][2]['name'] = resp.data[0]['brand']
                        //设置对应月份的数据
                        this.allDiscountPieOption['series'][2]['data'] = [resp.data[11].discount,resp.data[10].discount,resp.data[9].discount,resp.data[8].discount,resp.data[7].discount,resp.data[6].discount,resp.data[5].discount,resp.data[4].discount,resp.data[3].discount,resp.data[2].discount,resp.data[1].discount,resp.data[0].discount,]
        this.allDiscountPieCharts.setOption(this.allDiscountPieOption)
                    }
                })
                },
