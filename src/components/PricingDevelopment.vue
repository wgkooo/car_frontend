<template>
   <div class="wrapper">
      ...
      <el-checkbox-group v-model="selectBrandData" :max="1"> 
        ...
        <el-checkbox label="凯迪拉克"><img class="img" src="../assets/images/kaidilake.png"></el-checkbox>
        <el-checkbox label="路虎"><img class="img" src="../assets/images/luhu.png"></el-checkbox>
        <el-checkbox label="上汽大众"><img class="img" src="../assets/images/shangqi.png"></el-checkbox>
        <el-checkbox label="一汽大众"><img class="img" src="../assets/images/yiqi.png"></el-checkbox>
        <el-checkbox label="蔚来"><img class="img" src="../assets/images/nio.png"></el-checkbox>
        <el-checkbox label="威马"><img class="img" src="../assets/images/weima.png"></el-checkbox>
        <el-checkbox label="小鹏"><img class="img" src="../assets/images/xiaopeng.png"></el-checkbox>
        <el-checkbox label="理想"><img class="img" src="../assets/images/lixiang.png"></el-checkbox>
        <el-checkbox label="比亚迪"><img class="img" src="../assets/images/byd.png"></el-checkbox>
        <el-checkbox label="特斯拉"><img class="img" src="../assets/images/tsl.png"></el-checkbox>

        

        <!-- <el-checkbox label="斯科达"><img class="img" src="../assets/images/sikeda.png"></el-checkbox> -->
    </el-checkbox-group>
    </div>
     ...
     <div class="selectCompetitorsShowClass" v-show="selectCompetitorsShow">
       <el-checkbox-group v-model="selectCompetitorsData" :max="2"> 
        ...
        <el-checkbox label="凯迪拉克"  v-show="selectBrandData!='凯迪拉克'"><img class="img" src="../assets/images/kaidilake.png"></el-checkbox>
        <el-checkbox label="路虎" v-show="selectBrandData!='路虎'"><img class="img" src="../assets/images/luhu.png"></el-checkbox>
        <el-checkbox label="上汽大众" v-show="selectBrandData!='上汽大众'"><img class="img" src="../assets/images/shangqi.png"></el-checkbox>
        <el-checkbox label="一汽大众" v-show="selectBrandData!='一汽大众'"><img class="img" src="../assets/images/yiqi.png"></el-checkbox>
        <el-checkbox label="蔚来" v-show="selectBrandData!='蔚来'"><img class="img" src="../assets/images/nio.png"></el-checkbox>
        <el-checkbox label="威马" v-show="selectBrandData!='威马'"><img class="img" src="../assets/images/weima.png"></el-checkbox>
        <el-checkbox label="小鹏" v-show="selectBrandData!='小鹏'"><img class="img" src="../assets/images/xiaopeng.png"></el-checkbox>
        <el-checkbox label="理想" v-show="selectBrandData!='理想'"><img class="img" src="../assets/images/lixiang.png"></el-checkbox>
        <el-checkbox label="比亚迪" v-show="selectBrandData!='比亚迪'"><img class="img" src="../assets/images/byd.png"></el-checkbox>
        <el-checkbox label="特斯拉" v-show="selectBrandData!='特斯拉'"><img class="img" src="../assets/images/tsl.png"></el-checkbox>

        <!-- <el-checkbox label="斯科达" v-show="selectBrandData!='斯科达'"><img class="img" src="../assets/images/sikeda.png"></el-checkbox> -->
    </el-checkbox-group>
    </div>
   ...
   methods:{
      ...
      btn(){
         if(this.selectBrandData==''){
            ...
            this.$router.push({path:'/pricingDevelopmentDetail',query:{selectBrandData:this.selectBrandData,selectCompetitorsData:this.selectCompetitorsData}})
         }
      },
   }
}
